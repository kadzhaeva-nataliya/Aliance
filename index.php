...
<body class="front-page">
  ...
  <header class="header header-image">
      ...
      <div class="container">
        <div class="sepаrator">
          ...
          <div class="swiper steps-slider">
            ...
            <div class="steps-buttons primery-buttons-wrapper">
              <!-- классы, написанные через пробел - два разных класса -->
              <div class="steps-button-prev primery-button-prev">
                <svg width="36" height="24">
                <use href="img/sprite.svg#arrow-prev"></use>
              </svg>
              </div>
              <div class="steps-button-next primery-button-next">
                <svg width="36" height="24">
                <use href="img/sprite.svg#arrow-next"></use>
              </svg>
              </div>
    ...
    <?php $block_title = "Клиенты"; include_once('./template-parts/clients-block.php')?>
    ...
    <section class="section-blog">
      <div class="container">
        ...
        <!-- Additional required wrapper -->
          ...
          <!-- Slides -->
            <a href="#" class="swiper-slide blog-card"><img src="img/Blog1.jpg" alt="office" class="blog-card-image">
            ...
            <a href="#" class="swiper-slide blog-card"><img src="img/Blog2.jpg" alt="manufacture" class="blog-card-image">
            ...
            <a href="#" class="swiper-slide blog-card"><img src="img/Blog1.jpg" alt="" class="blog-card-image">
        ...
        <div class="blog-slider-footer">
          ...
          <div class="blog-buttons primery-buttons-wrapper">
            <!-- классы, написанные через пробел - два разных класса -->
            <div class="blog-button-prev primery-button-prev">
              <svg width="36" height="24">
              <use href="img/sprite.svg#arrow-prev"></use>
            </svg>
            </div>
            <div class="blog-button-next primery-button-next">
              <svg width="36" height="24">
              <use href="img/sprite.svg#arrow-next"></use>
            </svg>
            </div>
...
<!-- /*если нет footer на странице - то вставить единожды*/ -->
</body>
</html>